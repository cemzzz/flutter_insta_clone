...
class ProfileRepository{
  ...
  Future<UserModel> followUser({
    ...
    try{
      DocumentReference<Map<String, dynamic>> currentUserDocRef = firebaseFirestore.collection('users').doc(currentUserId);
      DocumentReference<Map<String, dynamic>> followUserDocRef = firebaseFirestore.collection('users').doc(followId);
